...
public abstract class PrimitiveDataClass implements DataClass {
  ...
  public abstract PrimitiveDataClassBrick makeBrick(String name, Object val, ArrayList<OuterDataClassBrick> outers, boolean isReadOnly);
  public abstract PrimitiveDataClassBrick makeBrick(String name, ArrayList<OuterDataClassBrick> outers, boolean isReadOnly);
}
